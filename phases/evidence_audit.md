...
| 6 | The HPO smoke records one seed and 16 aggregate training steps per method. ATLAS continues one trajectory for 16 steps while search baselines mostly stop trials after 2–4 steps; their final losses are not comparable training horizons. The local TPE-style class is not Optuna. No sampled peer diverged, and no target-loss step comparison proves a 2.5x speedup. |
